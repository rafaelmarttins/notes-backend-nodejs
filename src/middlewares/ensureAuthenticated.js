// Middleware para interceptar as requisições, pegar o token, e dentro do token pegar o id do usuário para identificar o usuário que está fazendo a requisição
